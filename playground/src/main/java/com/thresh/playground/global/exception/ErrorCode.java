...
public enum ErrorCode {
   ...
   * *********************************************************************************************
   */
  UNKNOWN_ERROR(404, "1000", "알 수 없는 오류 발생"),
  // 유저 예외처리
  ...
  MISSING_REQUEST_PARAMETER_ERROR(
      400,
      "3006",
      "Missing Servlet RequestParameter Exception"), // Request Parameter 로 데이터가 전달되지 않을 경우
  ...
  NOT_VALID_ERROR(
      404,
      "3013",
      "handle Validation Exception"), // @RequestBody 및 @RequestParam, @PathVariable 값이 유효하지 않음
  NOT_VALID_HEADER_ERROR(
      404,
      "3014",
      "Header에 데이터가 존재하지 않는 경우 "), // @RequestBody 및 @RequestParam, @PathVariable 값이 유효하지 않음
