package com.thresh.playground.global.security.jwt;
...
public class TokenUtils {
  ...
  private static final String jwtSecretKey =
      "thisIsASecretKeyUsedForJwtTokenGenerationAndItIsLongEnoughToMeetTheRequirementOf256Bits";
    ...
    JwtBuilder builder =
        Jwts.builder()
            ...
            .signWith(
                key,
                SignatureAlgorithm
                    .HS256) // Signature 구성 : 이 키를 사용하여 JWT 토큰에 서명을 추가한다. 이 서명은 토큰의 무결성을 보장하는 데
            // 사용된다.
