...
//
// import com.thresh.playground.global.security.interceptor.JwtTokenInterceptor;
...
//        .excludePathPatterns(
//            "/user/login", "/login", "/main/rootPage"); // 로그인 페이지는 JWT 토큰 검사에서 제외합니다.
//  }
//
...
//
//  /**
//   * 정적 리소스를 처리하는 핸들러를 추가하는데 사용된다. 여기서는 모든 요청("/**")에 대해 CLASSPATH_RESOURCE_LOCATIONS에 지정된 경로에서
// 리소스를
//   * 찾도록 설정하고 있다.
//   */
//  @Override
