...
public class SecurityConfig {
  ...
  /**
   * 2. authenticate 의 인증 메서드를 제공하는 매니져로'Provider'의 인터페이스를 의미한다. 이 메서드는 인증 매니저를 생성한다. 인증 매니저는 인증 과정을
  ...
  /**
   * 5. Spring Security 기반의 사용자의 정보가 맞지 않을 경우 수행이 되며 결과값을 리턴해주는 Handler customLoginFailureHandler: 이
